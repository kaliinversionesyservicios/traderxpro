...
def app_cncf():
    ...
    # URLs
    url_casos = "https://raw.githubusercontent.com/kaliinversionesyservicios/TraderEstrategias/main/data/cncf.txt"
    ...
    #trade_urls = { }
    mostrar_style_notebook("Estrategia Caida Normal - Caida Fuerte")
